            ...
            <section className="bg-white dark:bg-gray-800">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
                        <span className="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Beta</span> <span className="text-sm font-medium">Alfremo is out! See what's new (changelog 0.1.0)</span>
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at Alfremo we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
                    ...
                    <div className="max-w-screen-md px-4 mx-auto lg:px-12 w-full">
                    ...
                    <div className="px-4 mt-8 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
