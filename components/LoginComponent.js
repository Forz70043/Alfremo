...
export default function LoginComponent(props) {
    ...
    function onSubmit({ email, password }) {
        ...
        return userService.login(email, password)
            .then(() => {
                console.log("user SERVICE LOGIN THEN");
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 md:space-y-6">
                                ...
                                <div className="flex flex-col sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-0">
                                    <button type="button" onClick={() => signIn('github')} className="justify-center items-center inline-flex text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                                    ...
                                    <button type="button" onClick={() => signIn('google')}
                                        className="justify-center items-center inline-flex text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
                                    >
